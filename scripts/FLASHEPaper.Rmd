...
Our analysis focuses on adolescents so we filtered out participants age 13-18. 

## Calculating BMI - mutate
## Calculating Mean Physical Activity - summarize and group_by
 The {group_by} function allowed us to group our data by school type and sex to appropriately assess for associations between those demographic variables and average total weekly physical activity.
...
## Summary Table
have code for the summary table and can turn it into a plot like bar/col or error bars?
