...
## Study Aim Two
An ANOVA was used to determine if there was a significant association between type of school attended and amount of physical activity performed during the week. The results indicate that there is no significant association, (F(3,1188) = 0.736, p = 0.531 (p > .05)). Figure 4 provides a visualization of the associations between the variables of interest (School Type and Predicted Weekly MVPA)
