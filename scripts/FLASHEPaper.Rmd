...
# Results
## Participants
Table 1 displays the results of the descriptive characteristics of this sample. In total, there were `r count` in the final 
analysis. Participants were evenly distributed by age and sex, with a mean age of `r mean_age`. Adolescents' MVPA varied from as
low as `r min_MVPA` to as high as `r max_MVPA`. Average weekly MVPA was `r avg_MVPA`. The majority of participants reported attending a public school `r pct_pub_school`.
...
```{r fig-three-PA-BMI-race-ethnicity}
data %>% 
