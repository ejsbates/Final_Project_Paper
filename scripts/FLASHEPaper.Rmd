...
```
## Participants
Table 1 displays the results of the descriptive characteristics of this sample. In total, there were `r data %>% count() ` **in-line code here?** 1,192 participants in the final analysis. Adolescents' MVPA varied from as low as **in-line here?** 249.09 minutes to as high as **here too?** 630.16 minutes. Participants were evenly distributed by age and sex. The majority of participants reported attending a public school `r inline_text(table_data, variable = "School Type", level = "Public School", column = "N=1,192" `**in-line?** (85.99%).
