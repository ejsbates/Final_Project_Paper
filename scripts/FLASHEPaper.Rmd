...
## Participants 
__THIS DOES NOT WORK FOR KNIT right now, when i took it out and tried to run everything else (minus also the regression code chunk), everything else could knit... so this needs to be worked out still :)__
